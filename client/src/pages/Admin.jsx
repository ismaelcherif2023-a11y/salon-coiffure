...
export default function Admin() {
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '2rem' }}>
      ...
      <div style={{ background: '#eaf6f4', border: '2px solid #2a9d8f', borderRadius: '8px', padding: '1.5rem', marginBottom: '2rem' }}>
        <h2 style={{ marginBottom: '1rem' }}>Ajouter une coiffure</h2>
        {message && (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          ...
          <input placeholder="Description" value={form.description}
            ...
            style={{ padding: '0.7rem', borderRadius: '6px', border: '1px solid #ccc', gridColumn: 'span 2' }} />
          <div style={{ gridColumn: 'span 2' }}>
            <label style={{ display: 'block', marginBottom: '0.5rem' }}>Photo de la coiffure</label>
            <input type="file" accept="image/*"
              onChange={e => setImage(e.target.files[0])}
              style={{ padding: '0.4rem', border: '1px solid #ccc', borderRadius: '6px', width: '100%' }} />
            {image && (
          ...
          <button onClick={handleAjouter}
            style={{ gridColumn: 'span 2', background: '#2a9d8f', color: '#fff', border: 'none', padding: '0.8rem', borderRadius: '6px', cursor: 'pointer', fontSize: '1rem' }}>
            Ajouter la coiffure
          </button>
        </div>
      </div>

      <h2 style={{ marginBottom: '1rem' }}>Liste des rendez-vous</h2>
      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
        <thead>
          <tr style={{ background: '#f8f9fa' }}>
            <th style={{ padding: '0.8rem', textAlign: 'left' }}>Client</th>
            <th style={{ padding: '0.8rem', textAlign: 'left' }}>Téléphone</th>
            <th style={{ padding: '0.8rem', textAlign: 'left' }}>Coiffure</th>
